...
parser.add_argument("--tv", type=int, default='200')

parser.add_argument("--d", type=float, default='0.999')
parser.add_argument("--cth", type=float, default='0.65')
...
parser.add_argument("--esize", type=int, default=4330)
parser.add_argument("--dom", type=int, default=1)
parser.add_argument("--norm", type=int, default=0)

parser.add_argument("--batch_size", type=int, default=32)
parser.add_argument("--se", type=int, default=2)
parser.add_argument("--me", type=int, default=30)

parser.add_argument("--dpout_model", type=float, default=0., help="encoder dropout")
parser.add_argument("--dpout_fc", type=float, default=0., help="classifier dropout")
parser.add_argument("--nonlinear_fc", type=float, default=0, help="use nonlinearity in fc")
parser.add_argument("--optimizer", type=str, default="adam,lr=0.01", help="adam or sgd,lr=0.1")
...
parser.add_argument("--gnoise2", type=float, default=0.1, help="max norm (grad clipping)")
parser.add_argument("--dprob", type=float, default=0.05, help="max norm (grad clipping)")
parser.add_argument("--iprob", type=float, default=0.05, help="max norm (grad clipping)")
...
parser.add_argument("--enc_lstm_dim", type=int, default=32, help="encoder nhid dimension")
...
parser.add_argument("--sptrain", type=str, default='1', help="max or mean")
parser.add_argument("--th", type=float, default='0.8', help="max or mean")
parser.add_argument("--uss", type=int, default='-1', help="max or mean")
parser.add_argument("--uss2", type=int, default='-1', help="max or mean")

parser.add_argument("--sss", type=int, default='5', help="max or mean")
parser.add_argument("--ne0", type=int, default='5', help="max or mean")
